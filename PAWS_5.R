...
## merge the data files with teh EBEs
...
## function to allow ggplot graphs to be combined on a single page
...
print(vpcKA1tr1_PDceemax, vp = vplayout(1, 1))
print(vpcKA1tr1IPP_PDtoemax, vp = vplayout(2, 1))
